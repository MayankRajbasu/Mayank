function Hero() {
  return (
    <article className="flex gap-5 lg:justify-between xsm:justify-center relative flex-wrap items-center w-full h-screen lg:px-36 xsm:px-6 xsm:py-12">
      <div id="content" className="flex flex-col">
        <p className="font-regular text-teal-400 font-normal lg:text-lg xsm:text-base xsm:py-1">Hi, my name is</p>
        <p className="font-hero lg:text-7xl text-slate-300 font-semibold xsm:text-[36px] xsm:pb-1">Mayank Raj.</p>
        <p className="font-hero lg:text-6xl font-medium xsm:text-[32px] xsm:font-semibold pb-2 tracking-wide">I build things for the web and ML.</p>
