function Hero() {
  return (
    <article className="flex xl:gap-5 xl:justify-between xsm:justify-center relative flex-wrap items-center w-full min-h-screen xl:px-36 xl:py-0 sd:py-16 xsm:py-24">
