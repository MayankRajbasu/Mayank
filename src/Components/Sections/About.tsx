  ...
  return (
    <article className="flex justify-center gap-4 relative flex-wrap flex-col items-center w-full min-h-screen xl:px-36 xl:py-0 py-16">
      <div id="about-content" className="flex flex-col w-full mt-7 relative text-left">
        <h1 className="font-regular sm:text-2xl xsm:text-[22px] flex font-semibold text-slate-300 text-start tracking-tight mb-3 before:text-[16px] before:text-lg before:font-medium after:bg-slate-600 after:msd:w-60 after:sm:w-52 after:xsm:w-[96px] ">About Me</h1>
