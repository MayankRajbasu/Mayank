function About() {
  return (
    <article className="flex justify-center gap-4 relative flex-wrap flex-col items-center w-full h-screen xl:px-56 lg:px-6 sm:px-20 xsm:px-6 sd:py-36 xsm:py-12 ">
      <div id="about-content" className="flex flex-col w-full mt-7 relative ">
        <h1 className="font-regular text-2xl flex font-semibold text-slate-300 text-start mb-3 before:text-lg before:font-medium after:bg-slate-600 after:xsm:w-36 after:msd:w-52 after:sd:w-64 ">About Me</h1>
        <p className="relative font-regular pt-5 text-left text-sd">Hello! My Name is Mayank and I love to develop Website and work on ml models. Though I had an encounter with basics of HTML & CSS back in my 6th grade, for me a complete new journey in web development began in 2021 and fast forward to today, I have developed a bunch of small and mid-scale scale projects acquiring great skills in HTML & CSS!.</p>
