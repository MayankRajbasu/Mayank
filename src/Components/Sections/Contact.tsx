function Contact() {
  return (
    <article className="flex justify-center gap-4 relative flex-wrap flex-col items-center w-full min-h-screen xl:px-36">
      ...
      <div id="footer" className="relative xsm:top-28 sm:top-36 xl:top-52">
