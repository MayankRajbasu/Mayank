function Contact() {
  return (
    <article className="flex justify-center gap-4 relative flex-wrap flex-col items-center w-full min-h-screen xl:px-36 xsm:pt-16">
      ...
      <div id="footer" className="relative xsm:top-40 sm:top-48 xl:top-52">
        <div className="flex text-slate-300 justify-center gap-4">
          <a href="https://github.com/MayankRajbasu" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
          ...
          <a href="https://www.instagram.com/m_krajbasu/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-instagram hover:-translate-x-1 hover:-translate-y-1" >
          ...
          <a href="https://www.linkedin.com/in/mayankrajbasu/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
          ...
          <a href="mailto:mayank.09raj@gmail.com" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-mail hover:-translate-x-1 hover:-translate-y-1">
