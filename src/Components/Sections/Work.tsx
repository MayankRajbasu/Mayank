    ...
    <article className="flex justify-center gap-4 relative flex-wrap flex-col items-center w-full h-screen xl:px-64 lg:px-6 sm:px-20 xsm:px-6 sd:py-36 xsm:pb-12 xsm:pt-0 ">
      <div id="work-content" className="flex flex-col w-full sm:mt-7 xsm:mt-2 relative">
        ...
        <div className="relative font-regular sd:pt-5 xsm:pt-1 text-left sd:text-sd xsm:text-[12px]">
          <h2 className="font-hero font-medium sd:text-xl xsm:text-[18px]" >Frontend Intern <span className="text-teal-400">@ ScienceOverse</span></h2>
          <p className="font-regular sd:text-sd xsm:text-[16px] font-light">Apr 2024 - May 2024</p>
          ...
          <h2 className="font-hero font-medium sd:text-xl xsm:text-[18px] mt-4" >Data Science Intern <span className="text-teal-400">@ Let'sGrowMore</span></h2>
          <p className="font-regular sd:text-sd xsm:text-[16px] font-light">April 2024 - May 2024</p>
          <ul className="font-regular pt-2 pl-3 text-left">
