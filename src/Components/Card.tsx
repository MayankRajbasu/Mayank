...
const Card: React.FC<EventCardProps> = ({ event }) => {
    return (
        <div id="cards" className='text-slate-400 text-center relative' >
            ...
            <p className="text-teal-400 font-medium text-[18px] font-regular flex justify-center w-full p-2"><a href={event.link} target='_blank' className='flex items-center gap-3 '>{event.title} 
