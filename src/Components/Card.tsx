...
const Card: React.FC<EventCardProps> = ({ event }) => {
    ...
    return (
        <div id="cards" className='text-slate-400 text-center relative' >
            ...
            <p className="text-teal-400 font-medium text-[18px] font-regular flex gap-5 justify-center w-full p-2 items-center tracking-tighter"><a href={event.link1} target='_blank' className='flex items-center gap-3 '>{event.title}
